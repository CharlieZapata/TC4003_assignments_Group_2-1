...
//
// Message struct for request vote RPC
//
...
//
// Reply Message struct for RPC from follower to candidate
//
...
//
// PersistentState struct used for persister to persist the current peer state
//
